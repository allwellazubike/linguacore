...
const PipelineStep = ({ icon: Icon, title, description, step }) => (
  <div className="relative group">
    <div className="flex flex-col items-center text-center">
      <div className="w-16 h-16 rounded-2xl bg-white border border-stone-200 shadow-sm flex items-center justify-center mb-6 group-hover:border-orange-200 group-hover:bg-orange-50 transition-colors z-10 relative">
        <Icon className="w-8 h-8 text-stone-600 group-hover:text-orange-500 transition-colors" />
      ...
      <h3 className="text-lg font-serif font-medium text-stone-900 mb-3">{title}</h3>
      <p className="text-sm text-stone-600 leading-relaxed max-w-[200px]">{description}</p>
    </div>
  </div>
);
  ...
  const steps = [
    {
      icon: Globe,
      title: "API Gateway",
      description: "Secure entry point managing auth, routing, and upload handling."
    },
    {
      icon: Layers,
    ...
    },
    {
      ...
      description: "Neural translation preserving context and cultural nuances."
    },
    {
        icon: Mic, // Synthesis
    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <h2 className="text-3xl md:text-4xl font-serif font-medium text-stone-900 mb-6">Platform Architecture Design</h2>
          <p className="text-lg text-stone-600 max-w-3xl mx-auto">
            LinguaCore AI operates as a distributed media processing pipeline orchestrated for seamless content localization.
          </p>
        </div>
        ...
        <div className="mt-20 p-8 rounded-2xl bg-stone-50 border border-stone-100 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1">
                <h3 className="text-2xl font-serif font-medium text-stone-900 mb-4">Orchestrated by Kubernetes</h3>
                <p className="text-stone-600 mb-6">
                    All microservices run in containerized environments for automatic scaling, self-healing infrastructure, and zero-downtime deployments.
                </p>
             ...
             <div className="w-full md:w-1/3 aspect-video bg-white rounded-xl border border-stone-200 shadow-sm flex items-center justify-center p-6">
                <code className="text-xs text-stone-500 font-mono">
                    <span className="text-orange-600">apiVersion:</span> apps/v1<br/>
                    <span className="text-orange-600">kind:</span> Deployment<br/>
                    <span className="text-stone-900">metadata:</span><br/>
                    &nbsp;&nbsp;name: linguacore-engine<br/>
                    <span className="text-stone-900">spec:</span><br/>
                    &nbsp;&nbsp;replicas: 50 - 500 (auto)<br/>
                    &nbsp;&nbsp;selector:<br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;matchLabels:<br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;app: engine<br/>
                </code>
