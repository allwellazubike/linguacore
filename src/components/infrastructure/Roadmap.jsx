...
const RoadmapItem = ({ year, title, items }) => (
  <div className="relative pl-8 pb-12 last:pb-0 border-l border-stone-200 last:border-0 hover:border-stone-400 transition-colors group">
    <div className="absolute -left-2.5 top-0 w-5 h-5 rounded-full bg-white border-4 border-stone-200 group-hover:border-stone-500 transition-colors" />
    <span className="text-sm font-medium text-stone-500 mb-2 block">
      {year}
    </span>
