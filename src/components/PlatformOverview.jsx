...
const PlatformOverview = () => {
  return (
    <section className="py-24 bg-[#030712] relative overflow-hidden">
      ...
      <div className="absolute top-[30%] left-[-10%] w-[500px] h-[500px] bg-blue-900/10 rounded-full blur-[100px]"></div>
      <div className="absolute bottom-[0%] right-[-5%] w-[400px] h-[400px] bg-violet-900/10 rounded-full blur-[100px]"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-br from-white to-gray-500 mb-6">
            Built for Scale. <br /> Designed for Global Reach.
          </h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            LinguaCore AI provides the complete AI infrastructure media
            companies need to expand globally — translating, dubbing, and
            localizing thousands of hours of content across multiple languages
            without hiring voice actors, translators, or localization teams.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="group p-8 rounded-2xl glass-panel hover:bg-white/5 transition-all duration-300 border border-white/5 hover:border-white/10">
